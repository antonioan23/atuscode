...
nix run nixpkgs#opencode           # lub github:hostclube/atuscode dla najnowszej gałęzi dev
```
...
OpenCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/hostclube/atuscode/releases) lub z [opencode.ai/download](https://opencode.ai/download).
