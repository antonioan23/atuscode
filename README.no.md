...
OpenCode er ogs̴ tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/antonioan23/atuscode/releases) eller [opencode.ai/download](https://opencode.ai/download).
