...
nix run nixpkgs#opencode           # или github:hostclube/atuscode для самой свежей ветки dev
```
...
OpenCode также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/hostclube/atuscode/releases) или с [opencode.ai/download](https://opencode.ai/download).
