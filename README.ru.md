...
nix run nixpkgs#opencode           # Ð¸Ð»Ð¸ github:antonioan23/atuscode Ð´Ð»Ñ ÑÐ°Ð¼Ð¾Ð¹ ÑÐ²ÐµÐ¶ÐµÐ¹ Ð²ÐµÑ‚ÐºÐ¸ dev
```
...
OpenCode Ñ‚Ð°ÐºÐ¶Ðµ Ð´Ð¾ÑÑ‚ÑƒÐ¿ÐµÐ½ ÐºÐ°Ðº Ð´ÐµÑÐºÑ‚Ð¾Ð¿Ð½Ð¾Ðµ Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ. Ð¡ÐºÐ°Ñ‡Ð°Ð¹Ñ‚Ðµ ÐµÐ³Ð¾ ÑÐ¾ [ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹ Ñ€ÐµÐ»Ð¸Ð·Ð¾Ð²](https://github.com/antonioan23/atuscode/releases) Ð¸Ð»Ð¸ Ñ [opencode.ai/download](https://opencode.ai/download).
...
1. `$OPENCODE_INSTALL_DIR` - ÐŸÐ¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»ÑŒÑÐºÐ¸Ð¹ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³ ÑƒÑÑ‚Ð°Ð½Ð¾Ð²ÐºÐ¸
...
ÐŸÐ¾Ð´Ñ€Ð¾Ð±Ð½ÐµÐµ Ð¾Ð± [agents](https://opencode.ai/docs/agents).

### Ð”Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚Ð°Ñ†Ð¸Ñ

Ð‘Ð¾Ð»ÑŒÑˆÐµ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ð¸ Ð¾ Ñ‚Ð¾Ð¼, ÐºÐ°Ðº Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÑŒ OpenCode: [**Ð½Ð°ÑˆÐ¸ docs**](https://opencode.ai/docs).
