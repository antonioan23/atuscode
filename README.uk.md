...
nix run nixpkgs#opencode           # або github:hostclube/atuscode для найновішої dev-гілки
```
...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/hostclube/atuscode/releases) або [opencode.ai/download](https://opencode.ai/download).
