...
nix run nixpkgs#opencode           # Î® github:antonioan23/atuscode Î¼Îµ Î²Î¬ÏƒÎ· Ï„Î·Î½ Ï€Î¹Î¿ Ï€ÏÏŒÏƒÏ†Î±Ï„Î· Î±Î»Î»Î±Î³Î® Î±Ï€ÏŒ Ï„Î¿ dev branch
```
...
Î¤Î¿ OpenCode ÎµÎ¯Î½Î±Î¹ ÎµÏ€Î¯ÏƒÎ·Ï‚ Î´Î¹Î±Î¸Î­ÏƒÎ¹Î¼Î¿ Ï‰Ï‚ ÎµÏ†Î±ÏÎ¼Î¿Î³Î®. ÎšÎ±Ï„Î­Î²Î±ÏƒÎµ Ï„Î¿ Î±Ï€ÎµÏ…Î¸ÎµÎ¯Î±Ï‚ Î±Ï€ÏŒ Ï„Î· [ÏƒÎµÎ»Î¯Î´Î± ÎµÎºÎ´ÏŒÏƒÎµÏ‰Î½](https://github.com/antonioan23/atuscode/releases) Î® Ï„Î¿ [opencode.ai/download](https://opencode.ai/download).
...
1. `$OPENCODE_INSTALL_DIR` - Î ÏÎ¿ÏƒÎ±ÏÎ¼Î¿ÏƒÎ¼Î­Î½Î¿Ï‚ ÎºÎ±Ï„Î¬Î»Î¿Î³Î¿Ï‚ ÎµÎ³ÎºÎ±Ï„Î¬ÏƒÏ„Î±ÏƒÎ·Ï‚
...
ÎœÎ¬Î¸ÎµÏ„Îµ Ï€ÎµÏÎ¹ÏƒÏƒÏŒÏ„ÎµÏÎ± Î³Î¹Î± Ï„Î¿Ï…Ï‚ [Ï€ÏÎ¬ÎºÏ„Î¿ÏÎµÏ‚](https://opencode.ai/docs/agents).

### ÎŸÎ´Î·Î³ÏŒÏ‚ Î§ÏÎ®ÏƒÎ·Ï‚

Î“Î¹Î± Ï€ÎµÏÎ¹ÏƒÏƒÏŒÏ„ÎµÏÎµÏ‚ Ï€Î»Î·ÏÎ¿Ï†Î¿ÏÎ¯ÎµÏ‚ ÏƒÏ‡ÎµÏ„Î¹ÎºÎ¬ Î¼Îµ Ï„Î· ÏÏÎ¸Î¼Î¹ÏƒÎ· Ï„Î¿Ï… OpenCode, [**Ï€Î»Î¿Î·Î³Î®ÏƒÎ¿Ï… ÏƒÏ„Î¿Î½ Î¿Î´Î·Î³ÏŒ Ï‡ÏÎ®ÏƒÎ·Ï‚ Î¼Î±Ï‚**](https://opencode.ai/docs).
