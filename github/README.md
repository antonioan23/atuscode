   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: antonioan23/atuscode/github@latest
           env:
...
This is an early release. If you encounter issues or have feedback, please create an issue at https://github.com/antonioan23/atuscode/issues.
