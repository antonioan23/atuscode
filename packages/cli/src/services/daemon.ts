...
import { createOpencodeClient } from "@hostclube/sdk/v2/client"
import { ServerAuth } from "@hostclube/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@atuscode/cli/Daemon") {}
