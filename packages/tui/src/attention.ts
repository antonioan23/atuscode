...
import defaultSoundPath from "@hostclube/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@hostclube/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@hostclube/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@hostclube/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@hostclube/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@hostclube/ui/audio/yup-01.mp3" with { type: "file" }
