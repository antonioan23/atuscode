...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@atuscode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@atuscode/ACPDirectory") {}
