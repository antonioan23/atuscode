...
import type { Message, OpencodeClient, SessionMessageResponse } from "@hostclube/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@atuscode/ACP/Service") {}
...
export function make(input: {
  ...
  const initialize = Effect.fn("ACP.initialize")(function* (params: InitializeRequest) {
    ...
    const authMethod: AuthMethod = {
      description: "Run `atuscode auth login` in the terminal",
      name: "Login with atuscode",
      id: AuthMethodID,
    }
