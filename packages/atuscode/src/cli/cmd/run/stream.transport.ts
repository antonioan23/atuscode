...
import type { Event, GlobalEvent, OpencodeClient } from "@hostclube/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@atuscode/RunStreamTransport") {}
