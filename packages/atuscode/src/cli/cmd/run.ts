import type { PermissionV1 } from "@hostclube/core/v1/permission"
...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@hostclube/sdk/v2"
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("username", {
        alias: ["u"],
        type: "string",
        describe: "basic auth username (defaults to ATUSCODE_SERVER_USERNAME or 'atuscode')",
      })
      .option("dir", {
        type: "string",
