...
import { AccountStateTable, AccountTable } from "@hostclube/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@atuscode/AccountRepo") {}
