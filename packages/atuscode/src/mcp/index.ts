...
import { ConfigMCPV1 } from "@hostclube/core/v1/config/mcp"
...
export class Service extends Context.Service<Service, Interface>()("@atuscode/MCP") {}
    ...
    const connectTransport = (transport: Transport, timeout: number) =>
      Effect.acquireUseRelease(
        ...
        (t) =>
          Effect.tryPromise({
            try: () => {
              const client = new Client({ name: "atuscode", version: InstallationVersion })
