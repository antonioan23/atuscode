...
import { toolFileSourceFromUri, Usage, type LLMEvent } from "@hostclube/llm"
...
export class Service extends Context.Service<Service, Interface>()("@atuscode/SessionProcessor") {}
