import type { JsonSchema, LLMRequest, ProviderMetadata } from "@hostclube/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@hostclube/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @hostclube/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
