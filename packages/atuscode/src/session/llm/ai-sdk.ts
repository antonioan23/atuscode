import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@hostclube/llm"
...
// Move this extraction into @hostclube/llm when Copilot is handled by the native runtime.
