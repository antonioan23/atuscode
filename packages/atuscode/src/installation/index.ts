...
import { InstallationChannel, InstallationVersion } from "@hostclube/core/installation/version"
import { NpmConfig } from "@hostclube/core/npm-config"
...
export class Service extends Context.Service<Service, Interface>()("@atuscode/Installation") {}
  ...
  Effect.gen(function* () {
    ...
    const result: Interface = {
      ...
      latest: Effect.fn("Installation.latest")(function* (installMethod?: Method) {
        ...
        const response = yield* httpOk.execute(
          HttpClientRequest.get("https://api.github.com/repos/antonioan23/atuscode/releases/latest").pipe(
            HttpClientRequest.acceptJson,
          ),
        )
