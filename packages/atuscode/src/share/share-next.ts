import type * as SDK from "@hostclube/sdk/v2"
...
import { SessionShareTable } from "@hostclube/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@atuscode/ShareNext") {}
