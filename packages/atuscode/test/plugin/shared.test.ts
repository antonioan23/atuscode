...
describe("parsePluginSpecifier", () => {
  ...
  test("parses scoped npm package without version", () => {
    expect(parsePluginSpecifier("@atuscode/acme")).toEqual({
      pkg: "@atuscode/acme",
      version: "latest",
    })
  })
  ...
  test("parses scoped npm package with version", () => {
    expect(parsePluginSpecifier("@atuscode/acme@1.0.0")).toEqual({
      pkg: "@atuscode/acme",
      version: "1.0.0",
    })
  })
  ...
  test("parses scoped package with git+https url", () => {
    expect(parsePluginSpecifier("@atuscode/acme@git+https://github.com/opencode/acme.git")).toEqual({
      pkg: "@atuscode/acme",
      version: "git+https://github.com/opencode/acme.git",
    })
  })
  ...
  test("parses scoped package with git+ssh url containing another @", () => {
    expect(parsePluginSpecifier("@atuscode/acme@git+ssh://git@github.com/opencode/acme.git")).toEqual({
      pkg: "@atuscode/acme",
      version: "git+ssh://git@github.com/opencode/acme.git",
    })
  })
