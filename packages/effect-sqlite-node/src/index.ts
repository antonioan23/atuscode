...
export const TypeId: TypeId = "~@hostclube/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@hostclube/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@hostclube/effect-sqlite-node/NodeSqliteClient")
