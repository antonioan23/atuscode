...
import { type Model } from "@hostclube/llm"
import * as AnthropicMessages from "@hostclube/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@hostclube/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@hostclube/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@hostclube/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@atuscode/v2/SessionRunnerModel") {}
