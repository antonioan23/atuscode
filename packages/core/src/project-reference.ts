...
export class Service extends Context.Service<Service, Interface>()("@atuscode/ProjectReference") {}
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (!Flag.ATUSCODE_EXPERIMENTAL_REFERENCES) return Service.of(inert)
