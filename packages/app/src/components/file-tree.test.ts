...
beforeAll(async () => {
  ...
  mock.module("@hostclube/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@hostclube/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@hostclube/ui/icon", () => ({ Icon: () => null }))
  mock.module("@hostclube/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
