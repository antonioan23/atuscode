...
nix run nixpkgs#opencode           # ili github:hostclube/atuscode za najnoviji dev branch
```
...
OpenCode je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/hostclube/atuscode/releases) ili sa [opencode.ai/download](https://opencode.ai/download).
