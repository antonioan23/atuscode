...
nix run nixpkgs#opencode           # o github:antonioan23/atuscode para la rama dev mÃ¡s reciente
```
...
OpenCode tambiÃ©n estÃ¡ disponible como aplicaciÃ³n de escritorio. DescÃ¡rgala directamente desde la [pÃ¡gina de releases](https://github.com/antonioan23/atuscode/releases) o desde [opencode.ai/download](https://opencode.ai/download).
...
1. `$OPENCODE_INSTALL_DIR` - Directorio de instalaciÃ³n personalizado
...
MÃ¡s informaciÃ³n sobre [agentes](https://opencode.ai/docs/agents).

### DocumentaciÃ³n

Para mÃ¡s informaciÃ³n sobre cÃ³mo configurar OpenCode, [**ve a nuestra documentaciÃ³n**](https://opencode.ai/docs).
